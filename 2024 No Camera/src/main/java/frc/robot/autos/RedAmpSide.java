...
public class RedAmpSide extends SequentialCommandGroup {
    ...
    public RedAmpSide(Swerve s_Swerve, PhotonVision s_Vision, LinearActuator mLinearActuator, ShooterWheels mWheels, IntakeDrive mIntake, IntakeWrist mWrist, CommonMethodExtensions methods){
        ...
        Trajectory backUpInitial =
            TrajectoryGenerator.generateTrajectory(
                ...
                new Pose2d(-0.65, 0, new Rotation2d(0)),
        ...
        Trajectory pickUpThird =
            TrajectoryGenerator.generateTrajectory(
                ...
                List.of(new Translation2d(-0.1, 0)),
                // End 3 meters straight ahead of   where we started, facing forward
                new Pose2d(-4.85, 0, new Rotation2d(0)),
                config.setReversed(true));
        ...
        addCommands(
            ...
            //new InstantCommand((() -> s_Swerve.OneEightyGyro(-5))),
            new InstantCommand((() -> s_Swerve.OneEightyGyro(0))),
            ...
            new InstantCommand((() -> s_Swerve.setPose(pickUpSecondTrajectory.getInitialPose()))),
            //new InstantCommand((() -> s_Swerve.OneEightyGyro(-21))),
