...
public class BlueAmpSide extends SequentialCommandGroup {

    public BlueAmpSide(Swerve s_Swerve, PhotonVision s_Vision, LinearActuator mLinearActuator, ShooterWheels mWheels, IntakeDrive mIntake, IntakeWrist mWrist, CommonMethodExtensions methods){
        ...
        Trajectory driveToShoot =
            TrajectoryGenerator.generateTrajectory(
                ...
                // End 3 meters straight ahead of where we started, facing forward
                new Pose2d(4.35, 1, new Rotation2d(0)),
        ...
        addCommands(
            ...
            new AutoShooterAimAtTarget(mLinearActuator, s_Vision, methods).withTimeout(0.75),
            new WaitCommand(0.5),
            ...
            new AutoSwerveAim(s_Swerve, s_Vision).withTimeout(1.5),
            ...
            new InstantCommand((() -> s_Swerve.setPose(pickUpSecondTrajectory.getInitialPose()))),
            new InstantCommand((() -> s_Swerve.OneEightyGyro(28))),
            ...
            new AutoSwerveAim(s_Swerve, s_Vision).until(() -> isFinished()).withTimeout(1.5),

            new AutoShooterAimAtTarget(mLinearActuator, s_Vision, methods).withTimeout(1.5),
            new WaitCommand(0.5),
            new AutoHarvesterDriveStart(mIntake, -0.6),
