...
public class BlueAmpSideNew extends SequentialCommandGroup {

    public BlueAmpSideNew(Swerve s_Swerve, PhotonVision s_Vision, LinearActuator mLinearActuator, ShooterWheels mWheels, IntakeDrive mIntake, IntakeWrist mWrist, CommonMethodExtensions methods){
        ...
        addCommands(
            ...
            new InstantCommand((() -> s_Swerve.setPose(pickUpSecondTrajectory.getInitialPose()))),
            new InstantCommand((() -> s_Swerve.OneEightyGyro(31.5))),
